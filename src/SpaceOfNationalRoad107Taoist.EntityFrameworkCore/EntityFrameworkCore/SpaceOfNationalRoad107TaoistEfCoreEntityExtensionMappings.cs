...
public static class SpaceOfNationalRoad107TaoistEfCoreEntityExtensionMappings
{
    ...
    public static void Configure()
    {
        ...
        OneTimeRunner.Run(() =>
        {
                 ...
                 * USE SpaceOfNationalRoad107TaoistModuleExtensionConfigurator CLASS (in the Domain.Shared project)
